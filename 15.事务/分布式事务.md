...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA612.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA63A.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA687.tmp.jpg) 

举例，商品信息管理的执行流程：

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA698.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA699.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA69A.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA69B.tmp.jpg) 

###### 读己之所写（Read Your Writes）

“进程 1”写入变量 X 之后，该进程可以获取自己写入的这个值。

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA69C.tmp.jpg) 

###### 会话一致性（Session Consistency）

如果一个会话中实现来读己之所写。一旦数据更新，客户端只要在同一个会话中就可以看到这个更新的值。

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6AD.tmp.jpg) 

###### 单调写一致性（Monotonic Write Consistency）

“进程 1”如果有三个操作分别是 1，2，3。“进程 2”有两个操作分别是 1，2。当进程请求系统时，系统会保证按照进程中操作的先后顺序来执行。

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6AE.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6AF.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6BF.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6C0.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6C1.tmp.jpg) 

***\*一方出现故障：\****

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6C2.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6D3.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6D4.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6D5.tmp.jpg) 

当协调者发生故障的时候：

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6E6.tmp.jpg) 
...
尽量保证了数据的***\*强一致性\****，适合对数据强一致性要求很高的关键领域。
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6E7.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6E8.tmp.jpg) 
...
**跟2PC比，它的核心价值应该是少了锁资源的代价**。流程也相对简单一点。但实际操作中，补偿操作不太好定义，其中间状态处理也会比较棘手（可以通过全局事务ID实现回滚）。
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6E9.tmp.jpg) 

**分支事务执行成功：**

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6F9.tmp.jpg) 

**分支事务执行失败：**

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6FA.tmp.jpg) 

 

接入TCC前，业务操作只需要一步就能完成，但是在接入TCC之后，需要考虑如何将其分成2阶段完成，把资源的检查和预留放在一阶段的Try操作中进行，把真正的业务操作的执行放在二阶段的Confirm操作中进行；

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6FB.tmp.jpg) 

TCC服务要保证第一阶段Try操作成功之后，二阶段Confirm操作一定能成功。

#### 原理

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6FC.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6FD.tmp.jpg) 

顾名思义，TCC实现分布式事务一共有三个步骤：

1、Try：尝试待执行的业务

这个过程并未执行业务，只是完成所有业务的**一致性检查及资源预留（隔离），并锁定和预留好执行所需的全部资源**。它和后续的confirm一起才能真正构成一个完整的业务逻辑。
...
|      |                                                              |
| ---- | ------------------------------------------------------------ |
|      | ![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA6FE.tmp.jpg) |
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA70F.tmp.jpg) 

云服务方案：

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA710.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA720.tmp.jpg) 

 

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA721.tmp.jpg) 
...
**解决思路：**要识别出这个空回滚。**思路就是需要知道一阶段是否执行，如果执行了，就是正常回滚；如果没有执行，那就是空回滚。**TM在发起全局事务时生成全部事务记录，全局事务ID（gtid）贯穿整个分布式事务调用链条。再额外增加一张分支事务记录表，其中有全部事务ID和分支事务ID，第一阶段Try方法里会插入一条记录，表示一阶段执行了。Cancel接口里读取该记录，如果该记录存在，则正常回滚；如果该记录不存在，则是空回滚。

##### 幂等

无论是网络数据包重传，还是异常事务的补偿执行，都会导致TCC服务的Try、Confirm或者Cancel操作被重复执行；用户在实现TCC服务时，需要考虑幂等控制，即Try、Confirm、Cancel 执行一次和执行多次的业务结果是一样的。

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA722.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA723.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA724.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA735.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA736.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA737.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA748.tmp.jpg) 
...
|      |                                                              |
| ---- | ------------------------------------------------------------ |
|      | ![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA749.tmp.jpg) |
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA74A.tmp.jpg) 
...
|      |                                                              |
| ---- | ------------------------------------------------------------ |
|      | ![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA74B.tmp.jpg) |
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA75B.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA75C.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA76D.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA76E.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA76F.tmp.jpg) 

**二阶段提交：**

二阶段如果是提交的话，因为“业务SQL”在一阶段已经提交至数据库， 所以Seata框架只需将一阶段保存的快照数据和行锁删掉，完成数据清理即可。

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA770.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA781.tmp.jpg) 

AT模式的一阶段、二阶段提交和回滚均由Seata框架自动生成，用户只需编写“业务 SQL”，便能轻松接入分布式事务，AT 模式是一种对业务无任何侵入的分布式事务解决方案。

 

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA782.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA783.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA784.tmp.jpg)
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA785.tmp.jpg) 

Cancel 接口设计时需要允许空回滚。在 Try 接口因为丢包时没有收到，事务管理器会触发回滚，这时会触发 Cancel 接口，这时 Cancel 执行时发现没有对应的事务 xid 或主键时，需要返回回滚成功。让事务服务管理器认为已回滚，否则会不断重试，而 Cancel 又没有对应的业务数据可以进行回滚。

3 TCC 设计 - 防悬挂控制：

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA795.tmp.jpg) 

悬挂的意思是：Cancel 比 Try 接口先执行，出现的原因是 Try 由于网络拥堵而超时，事务管理器生成回滚，触发 Cancel 接口，而最终又收到了 Try 接口调用，但是 Cancel 比 Try 先到。按照前面允许空回滚的逻辑，回滚会返回成功，事务管理器认为事务已回滚成功，则此时的 Try 接口不应该执行，否则会产生数据不一致，所以我们在 Cancel 空回滚返回成功之前先记录该条事务 xid 或业务主键，标识这条记录已经回滚过，Try 接口先检查这条事务xid或业务主键如果已经标记为回滚成功过，则不执行 Try 的业务操作。

4 TCC 设计 - 幂等控制：

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA796.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA797.tmp.jpg) 

两阶段设计：

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA7A8.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA7A9.tmp.jpg) 

Saga 模式下分布式事务通常是由事件驱动的，各个参与者之间是异步执行的，Saga 模式是一种长事务解决方案。

###### 使用场景

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA7AA.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA7AB.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA7AC.tmp.jpg) 

该状态机引擎的基本原理是，它基于事件驱动架构，每个步骤都是异步执行的，步骤与步骤之间通过事件队列流转，极大的提高系统吞吐量。每个步骤执行时会记录事务日志，用于出现异常时回滚时使用，事务日志会记录在与业务表所在的数据库内，提高性能。

###### 状态机引擎设计

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA7BC.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA7BD.tmp.jpg) 

2）Saga 服务设计 - 防悬挂控制

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA7CE.tmp.jpg) 

3）Saga 服务设计 - 幂等控制

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA7CF.tmp.jpg) 

4）Saga 设计 - 自定义事务恢复策略

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA7D0.tmp.jpg) 
...
两种 Saga 实现优劣对比两种 Saga 的实现各有缺点，下面表格是一个对比：

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA7D1.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA7E2.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA7E3.tmp.jpg) 
...
![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA7F3.tmp.jpg) 

由于理论上，一个事务不会操作全部分片，仅操作1~2个分片（如转账业务），再加上TDSQL的MPP架构的原因，因此一个分布式实例多个分片的分布式事务性能可以叠加。

![img](file:///C:\Users\大力\AppData\Local\Temp\ksohtml\wpsA7F4.tmp.jpg) 
